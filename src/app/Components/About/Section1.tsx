        ...
        <div className="lg:grid grid-cols-2 sm:gap-4 space-y-11 lg:space-y-4  ">
          ...
          <div className="">
            ...
            <a href="/Cv/cv resume.pdf" download={"My-CV"}>
              <Button
                variant="ghost"
                className="flex justify-center hover:italic font-semibold hover:bg-blue-600  rounded-full border-2 border-blue-600 delay-500 duration-300 pr-0 "
              >
                Download Resume
          ...
          <div className="grid grid-cols-2 gap-7">
            <div className="transform h-32 hover:scale-110 duration-500 hover:shadow-md  bg-stone-100 shadow-sm   shadow-black dark:shadow-white dark:bg-slate-700">
              <span className="text-xl text-red-500 dark:text-blue-500 font-extrabold ">
                600+
              </span>
              <p className="text-sm sm:text-base pl-3 sm:pl-8 pt-3 italic">
                LINES OF CODE
              </p>
            </div>
            <div className="transform h-32 hover:scale-110 duration-500 hover:shadow-md  bg-stone-100 shadow-sm  shadow-black dark:shadow-white dark:bg-slate-700">
