  ...
  return (
    <Reveal>
      <div className="px-[3%] py-3 flex flex-col md:flex-row justify-center place-items-center gap-10 ">
        {/* Image */}
        <div className=" lg:hover:rotate-2  bg-red-400  dark:bg-blue-500  lg:w-2/6 md:w-3/6 w-3/5 mb-10 object-cover object-center rounded-full ">
          <Image
            src={p1}
            alt="product"
            className="flex align-middle rotate-0  rounded-full justify-between h-full w-full "
          />
        </div>

        {/* Text */}
        <div className=" flex-1">
          <p className="lg:text-xl md:text-lg sm:text-xl">
            Hi, I&apos;m <strong>EMAN ALI ABBASI</strong>
          </p>
          {/* type effect */}
          <Typeeffect />
          {/*  */}
          <p className="lg:text-lg sm:text-lg md:text-base font-extralight italic py-8">
            I&apos;m eager to apply my passion for frontend development and
            learn the ropes in crafting innovative solutions that utilize the
          ...
          <a href="/Cv/cv resume.pdf" download={"My-CV"}>
            <Button
              variant="ghost"
              className="flex hover:italic justify-center font-semibold hover:bg-blue-600  rounded-full border-2 border-blue-600 delay-500 duration-300 pr-0"
            >
              Download Resume{" "}
